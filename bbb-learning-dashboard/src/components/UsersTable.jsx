              ...
              .map((user) => {
                ...
                return (
                  <tr key={user} className="text-gray-700">
                    ...
                    <td className={`px-4 py-3 text-sm text-center items-center ${opacity}`} data-test="userTalkTime">
                    ...
                    <td className={`px-4 py-3 text-sm col-text-left ${opacity}`} data-test="totalUserEmojis">
                      {
